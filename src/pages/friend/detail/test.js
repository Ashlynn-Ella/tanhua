...
import { Carousel } from 'teaset-pro'
...
class Detail extends Component {
  ...
  getDetail = async () => {
    ...
    const res = await request.get(`/friends/personalInfo/${this.props.route.params.id}`, {
      headers: {
        "Authorization": `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NywibmFtZSI6IjE4NjY1NzExOTc4IiwiaWF0IjoxNjI2NjYwNzc3LCJleHAiOjE2NTI1ODA3Nzd9.lVG0YgusyormJmKQ6r4n-spgKdN0ZBiV0cBBsDrCGZQ`,
      },
      params: this.params
    })
    console.log(res)
